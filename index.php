...
$router->addRoute(new Route('/', 'GET', 'Home', 'home', ["ROLE_PUBLIC"]));
$router->addRoute(new Route('/test/email', 'GET', 'Home', 'testEmail', ["ROLE_PUBLIC"]));
$router->addRoute(new Route('/test/email', 'POST', 'Home', 'testEmail', ["ROLE_PUBLIC"]));
