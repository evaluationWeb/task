<nav>
    ...
    <ul>
        ...
        <li><a href="<?= BASE_URL ?>/user/deconnexion"><img src="<?= BASE_URL ?>/public/image/<?= $_SESSION["img"] ?>" alt="image de profil" title="profil"></a></li>
        <li><a href="<?= BASE_URL ?>/user/profil"><img src="<?= BASE_URL ?>/public/image/logout.png" alt="deconnexion" title="deconnexion"></a></li>
        <?php else : ?>
        <!-- Menu déconnecté -->
